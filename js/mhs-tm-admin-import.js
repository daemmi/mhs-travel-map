var mhs_tm_admin_import = mhs_tm_admin_import || {};
...
jQuery( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        $( "#mhs_tm_list" ).on( 'click', '.mhs_tm_button_save', function () {
            ...
            var id = $( this ).attr( 'id' );
            mhs_tm_admin_import.save_route( id_number, id );
            ...
            Papa.parse( file.files[0], {
                ...
                complete: function ( results ) {
                    ...
                    $.each( routes, function ( key, value ) {
                        mhs_tm_admin_import.auto_list_add( value, key );
                    } );
        ...
        mhs_tm_admin_import.auto_list_add = function( route, id ) {
            ...
            html = html + mhs_tm_utilities.utilities.get_buttons( id );
        ...
        //save sequentiel all listed routes
        mhs_tm_admin_import.save_all = function() {
            //get the last element
            var id_number_max = $( '.mhs_tm_button_save' ).last().attr( 'id' ).replace( /mhs_tm_button_save_/, '' );
        ...
        mhs_tm_admin_import.save_route = function( id_number, id ) {
            var name = '';
