...
//        if(isset($_GET['filter_name']) and $_GET['filter_name']!="all"){
//                $filter_name = $_GET['filter_name'];
//                $kurse = $wpdb->get_results(
//                        "SELECT * FROM ". $table_name .
//                        " WHERE kurs_status = 1 AND kurs_name = '".$filter_name."'",
//                        ARRAY_A
//                );
//        }else{
                $maps = $wpdb->get_results(
                        "SELECT * FROM ". $table_name .
                        " WHERE active = 1 order by create_date DESC",
                        ARRAY_A
                );	
//        }
